...
function Category() {
    ...
    console.log(category,' all caregory arr');
...
<div className="w-90 mx-auto"> {/* Apply the w-90 and mx-auto classes */}
...
function dispatch(arg0: { payload: any; type: "user/logoutUser" }) {
