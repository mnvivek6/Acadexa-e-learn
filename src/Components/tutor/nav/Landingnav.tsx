...
function Landingnav() {
  return (
    <div>
      <nav className="fixed top-0 left-0 w-full h-20  bg-deelviolet border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800 z-50">
...
<span className="text-pink-700">o</span> */}
                    ...
                    <div className="hidden justify-between items-center w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                        <ul className="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                            ...
                            {/* <li>
                                <a href="" className="block py-2 pr-4 pl-3 text-white border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 dark:text-gray-400  lg:dark:hover:bg-transparent dark:border-gray-700">Login</a>
                            </li> */}
